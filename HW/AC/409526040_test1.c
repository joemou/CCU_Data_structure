...
int main() {
    ...
    */
    ...
    while(!isIntQueueEmpty(&q[0])){
        printf("%d",dequeueInt(&q[0]));
    }
    while(!isIntQueueEmpty(&q[1])){
        printf("%d",dequeueInt(&q[1]));
    }
    while(!isIntQueueEmpty(&q[2])){
        printf("%d",dequeueInt(&q[2]));
    }
    while(!isIntQueueEmpty(&q[3])){
        printf("%d",dequeueInt(&q[3]));
    }
